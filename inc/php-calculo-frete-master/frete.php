...
class Frete{
	...
	public function __contrusct(
		...
		if(!$this->xml->Serviços->cServico){
			throw new Exception("Error Processing Request", 400);
		}

		if($this->xml->Serviços->cServico->Erro!='0' && !$this->xml->Servicos->cServico->Erro == '010'){
	...
	public function getPrazoEntrega(){
		return (int)$this->xml->Servico->cServico->PrazoEntrega;
	}
	...
	public function getValorMaoPropria(){
		return(float)str_replace(',','.',$this->xml->Servico->cServico->ValorMaoPropria);
	}
